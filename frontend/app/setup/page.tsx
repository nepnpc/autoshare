  ...
  if (!mounted || fetching) return (
    <main style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem" }}>
        <div style={{ width: "28px", height: "28px", borderRadius: "50%", border: "2px solid var(--border-hi)", borderTopColor: "var(--bright)", animation: "spin 0.8s linear infinite" }} />
  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg)", overflow: "hidden", position: "relative" }}>
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse, rgba(35,134,54,0.12) 0%, transparent 70%)",
      ...
      <div style={{ position: "relative", zIndex: 5, padding: "3rem 1.5rem 4rem", maxWidth: "640px", margin: "0 auto" }}>
        ...
        <form onSubmit={handleSubmit}>
          {accounts.map((acct, idx) => (
            ...
            >
              ...
              <div style={{
                ...
                background: "radial-gradient(circle at 100% 0%, rgba(57,211,83,0.05) 0%, transparent 70%)",
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.25rem" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                  <div style={{
                    fontFamily: "'DM Mono', monospace", fontSize: "0.65rem",
                    color: "var(--bright)", letterSpacing: "0.1em",
                    background: "rgba(57,211,83,0.08)", border: "1px solid var(--border-hi)",
                  ...
                  {isEditing && acct.meroshare_user && !acct.meroshare_pass && (
                    <span style={{
                      ...
                      color: "var(--muted)", letterSpacing: "0.06em",
                      background: "rgba(57,211,83,0.04)", border: "1px solid var(--border)",
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.875rem" }}>
                ...
                <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  <input
                    ...
                    onBlur={e => (e.target as HTMLInputElement).style.borderColor = "rgba(57,211,83,0.15)"}
                  />
          ...
          <button type="button" onClick={addAccount} style={{
            ...
            borderRadius: "10px", background: "rgba(57,211,83,0.03)",
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLButtonElement).style.background = "rgba(57,211,83,0.07)";
              (e.currentTarget as HTMLButtonElement).style.color = "var(--bright)";
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.background = "rgba(57,211,83,0.03)";
          ...
          <button type="submit" disabled={loading} style={{
            ...
            borderRadius: "10px",
            background: loading ? "var(--green)" : "linear-gradient(135deg, var(--green), var(--glow))",
            color: "#fff", fontWeight: 700, fontSize: "1rem",
            fontFamily: "'Outfit', sans-serif",
            border: "none", cursor: loading ? "not-allowed" : "pointer",
            opacity: loading ? 0.7 : 1,
            boxShadow: loading ? "none" : "0 0 32px rgba(35,134,54,0.4)",
            transition: "all 0.2s",
          }}
            onMouseEnter={e => { if (!loading) (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 0 48px rgba(57,211,83,0.5)"; }}
            onMouseLeave={e => { if (!loading) (e.currentTarget as HTMLButtonElement).style.boxShadow = "0 0 32px rgba(35,134,54,0.4)"; }}
          >
            {loading
        ...
        <div style={{
          ...
          background: "rgba(57,211,83,0.03)", border: "1px solid var(--border)",
