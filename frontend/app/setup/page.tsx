  ...
  if (!mounted || fetching) return (
    <main style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "1rem" }}>
        ...
        <span style={{ fontFamily: "'Roboto Mono', monospace", fontSize: "0.72rem", color: "var(--muted)", letterSpacing: "0.1em" }}>LOADING…</span>
      </div>
    </main>
  );
      ...
      <div style={{ position: "relative", zIndex: 5, padding: "3rem 1.5rem 4rem", maxWidth: "640px", margin: "0 auto" }}>
        ...
        <form onSubmit={handleSubmit}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.875rem" }}>
                ...
                <div style={{ gridColumn: "1 / -1" }}>
                  ...
                  <input
                    ...
                    onBlur={e => (e.target as HTMLInputElement).style.borderColor = "rgba(15,23,42,0.12)"}
                  />
                  <span style={{ fontFamily: "'Roboto Mono', monospace", fontSize: "0.68rem", color: "var(--dim)", marginTop: "0.3rem", display: "block" }}>
          ...
          <button type="button" onClick={addAccount} style={{
            ...
            fontSize: "0.875rem", fontFamily: "'Roboto Mono', monospace",
