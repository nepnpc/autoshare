...
export default function LandingPage() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--bg)", overflow: "hidden" }}>
      ...
      {/* Footer */}
      <footer style={{ padding: "2.5rem 2rem", textAlign: "center", position: "relative", zIndex: 5, borderTop: "1px solid var(--border)" }}>
        <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.65rem", color: "var(--dim)", marginBottom: "1.25rem", letterSpacing: "0.06em" }}>
          BUILT BY
        </p>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "1rem", flexWrap: "wrap", marginBottom: "1.5rem" }}>
          <a href="https://github.com/nepnpc" target="_blank" rel="noopener noreferrer" style={{
            ...
            background: "rgba(240,246,252,0.04)", border: "1px solid var(--border)",
        ...
        <p style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.65rem", color: "var(--dim)" }}>
